...
class TestCreateAdvert:
    """Класс, объединяющий тесты функционала создания объявлений"""

    def test_create_advert_auth_user(self, driver, create_user):  
        advert_name = "name"
        ...
        # Пароль и логин вводим через find_element
