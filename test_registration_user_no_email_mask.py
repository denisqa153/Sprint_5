...
class TestRegistrationNoEmailMask:
    """Класс, объединяющий тесты валидации маски email при регистрации"""

    EXPECTED_ERROR_COLOR = "255, 105, 114"

    def test_registration_user_no_email_mask(self, driver):  
        ...
        # Проверка рамки некорректного Email
